...
{
([\AtomLens_1;\ldots;\AtomLens_n],[\String_{1,1};\ldots;\String_{n+1,1}],[\String_{1,2};\ldots;\String_{n+1,2}],\sigma) : ([\Atom_{1,1};\ldots;\Atom_{n,1}],[\String_{1,1};\ldots;\String_{n+1,1}]) \Leftrightarrow ([\Atom_{\sigma^{-1}(1),2};\ldots;\Atom_{\sigma^{-1}(n),2}],[\String_{1,2};\ldots;\String_{n+1,2}])
}
