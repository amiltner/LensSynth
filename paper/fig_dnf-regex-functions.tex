...
\caption{DNF Regex Functions \bcp{Instead of these heavy alphabetic names,
    could we just lift the usual symbolic notations for all the operations
    to the various forms of DNF regexps?}}
