...
\end{itemize}
\caption{Lens Semantics \bcp{There are several places where it's hard to
    parse because there's not enough space around things.  In general,
    operators that bind looser should have more space.  (E.g., the unique
    splittability ones need a bit of space.)  I also don't see where these
