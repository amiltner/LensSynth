...
\newcommand{\ConstLensOf}[2]{\ensuremath{\mathit{const}(#1,#2)}}
\newcommand{\ConcatLensOf}[2]{\ensuremath{\mathit{concat}(#1,#2)}}
\newcommand{\ConcatLensShortOf}[2]{\ensuremath{\mathit{c}(#1,#2)}}
\newcommand{\SwapLensOf}[2]{\ensuremath{\mathit{swap}(#1,#2)}}
\newcommand{\SwapLensShortOf}[2]{\ensuremath{\mathit{s}(#1,#2)}}
\newcommand{\OrLensOf}[2]{\ensuremath{\mathit{or}(#1,#2)}}
...
\newcommand{\IterateLensOf}[1]{\ensuremath{\mathit{iterate(#1)}}}
...
\newcommand{\ToDNFRegexOf}[1]{\ensuremath{\ToDNFRegex(#1)}}
\newcommand{\ToRegex}{\ensuremath{\Uparrow}}
\newcommand{\ToRegexOf}[1]{\ensuremath{\ToRegex(#1)}}
...
\newcommand{\QuotientstarRule}{\textit{Quotientstar}}
...
\newcommand{\RewriteTo}{\ensuremath{\,\mathrlap{\to}\,{\scriptstyle\parallel}\,\,\,}}
\newcommand{\RewriteToAtom}{\ensuremath{\RewriteTo_{\Atom}}}
...
\newcommand{\DiamondProperty}{\ensuremath{\diamondsuit}}
\newcommand{\DiamondPropertyWithPropertyOf}[1]{\ensuremath{\DiamondProperty_{#1}}}
\newcommand{\IsConfluentWithPropertyOf}[2]{\ensuremath{#1\models\DiamondPropertyWithPropertyOf{#2}}}
...
\newcommand{\IdentityRewriteRule}{\textsc{IdentityRewrite}}
\newcommand{\StarIntroRewriteRule}{\textsc{StarIntroRewrite}}
\newcommand{\ConcatIntroRewriteRule}{\textsc{ConcatIntroRewrite}}
\newcommand{\OrIntroRewriteRule}{\textsc{OrIntroRewrite}}
\newcommand{\ConcatAssocRewriteRule}{\textsc{ConcatAssocRewrite}}
\newcommand{\LeftDistributivityRewriteRule}{\textsc{LeftDistributivityRewrite}}
\newcommand{\RightDistributivityRewriteRule}{\textsc{RightDistributivityRewrite}}
\newcommand{\OrCommuteRewriteRule}{\textsc{OrCommuteRewrite}}
\newcommand{\LeftUnrollRewriteRule}{\textsc{LeftUnrollRewrite}}
\newcommand{\RightUnrollRewriteRule}{\textsc{RightUnrollRewrite}}
\newcommand{\LeftQuotientRewriteRule}{\textsc{LeftQuotientRewrite}}
\newcommand{\LeftQuotientRewriteRuleOf}[1]{\textsc{\LeftQuotientRewriteRule\textsubscript{\ensuremath{#1}}}}
\newcommand{\RightQuotientRewriteRule}{\textsc{RightQuotientRewrite}}
\newcommand{\RightQuotientRewriteRuleOf}[1]{\textsc{\RightQuotientRewriteRule\textsubscript{\ensuremath{#1}}}}

\newcommand{\DNFLensHasSemanticsOf}[1]{\ToDNFRegex\SemanticsOf{#1}}
