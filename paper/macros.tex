...
\newcommand{\ConjunctUnambigConcatOf}[1]{\ensuremath{\UnambigConcat(#1)}}
...
\newcommand{\OrCommutativityRule}{\textit{\Or{} Commut}}
...
\newcommand{\ProductstarRule}{\textit{Productstar}}
