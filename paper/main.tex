...
\begin{lemma}[Expressibility of Adjacency Swapping Permutation of Separated
  ...
  \DNFOf{\SequenceOf{\Sep}} \ConcatDNF \DNFRegex_n \ConcatDNF \DNFOf{\SequenceOf{\Sep}} \Leftrightarrow
...
\begin{proof}
  ...
  unambiguous,
  and further than $\SequenceUnambigConcatOf{\DNFOf{\SequenceOf{\Sep}}
  \DNFRegex_1 , \DNFOf{\SequenceOf{\Sep}} , 
  \ldots , \DNFOf{\SequenceOf{\Sep}}, 
  \DNFOf{\SequenceOf{\Sep}} ,\DNFRegex_n ,\DNFOf{\SequenceOf{\Sep}}}$
