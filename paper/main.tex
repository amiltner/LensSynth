...
\begin{restatable}[Translation Soundness]{theorem}{dnfrs}
  \label{thm:dnfrs}
...
of a user-defined
definition for its name required to obtain these regular
...
\begin{proof}
  ...
  \begin{case}[\MultiOrDNFRegexType{}]
    ...
    $\SemanticsOf{(\DNFLensOf{\SequenceLens_1\DNFLSep\ldots \DNFLSep \ldotgs \SequenceLens_n},\Identity)}
    = 
    \SetOf{(\String,\String)
      \SuchThat \exists i.
