...
Because DNF normal form flattens a series of unions or concatenations
...
$\RegexOr{\EmptyString{}}{(\RegexConcat{\Regex{}}{\StarOf{{\Regex{}}}})}$ is
not a \emph{DNF} regular expression, so it uses DNF concatenation (\ConcatDNF)
