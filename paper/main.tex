...
Interestingly, \textbf{DNF+UD} performs \emph{worse} than \textbf{DNF}.
Adding in \textbf{UD} introduces the additional search through substitutions.
...
expansions, \textbf{DNF+UD} can only synthesize lenses which
...
\begin{figure}
  \includegraphics[width=\textwidth]{generated-graphs/uninferred}
...
By adding the optimization \textbf{FE} to the mix, we can
determine that many expansions are forced, so 
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{generated-graphs/examples.eps}
