...
\ksf{Anders, can you confirm that the description of GetTransitiveSet
is correct?}
...
\ksf{In the algorithm for FixProblemElts, should it return qes instead
of t?}
...
\ksf{Say something about where these orderings come from.}
For
