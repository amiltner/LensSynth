...
\begin{algorithm}
  ...
  \begin{algorithmic}[1]
    \Function{SynthDNFLens}{$\mathit{Q},\mathit{exs}$}
    ...
    \State \textbf{return} $\Call{SynthDNFLens}{\mathit{Q''},\mathit{exs}}$
    \Else
    ...
    \State $\DNFLens \gets \Call{SynthDNFLens}{\mathit{Q},\mathit{exs}}$
...
In \PCF{SynthDNFLens}, a priority queue of typing constraints is created, and the
