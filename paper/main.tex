...
\begin{figure}
  ...
  \caption{Average number of random examples required to synthesize benchmark
    ...
    required for full code coverage. \ksf{Does this mean we may have
      ...
      have any data to tell us whether we picked the right one or not?  No, it's
      more that we pick one option that requires minimal amounts of swaps, but
      there are other possible lenses with different semantics which satisfy
      the specification.}}
  \label{fig:exs-reqd}
\end{figure}
