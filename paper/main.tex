...
\cite{Krob}.\footnote{There are other complete axiomitizations for
  regular expression equivalence, such as Kozen's\cite{?} and Solomaa's\cite{?}.
...
require \afm{5} or fewer expansions.  However, some lenses require over 50
...
In our benchmark suite, \ExpandRequired{} infers a median of \afm{11}
...
any examples: only \afm{five} benchmarks need a nonzero number of examples to
