...
any examples: only \afm{three} benchmarks need a nonzero number of examples to
synthesize the correct lens. A clever user may be able to reduce the
...
For example, the benchmark \CF{cust/addr-probs} requires examples because it
