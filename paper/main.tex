...
After finding appropriate permutations, we can
synthesize a rewriteless DNF lens between
$\DNFOf{\Sequence_1;\ldots;\Sequence_n}$ and
$\DNFOf{\SequenceAlt_1;\ldots;\SequenceAlt_n}$ simply by finding a
sequence lens between $\Sequence_i$ and $\SequenceAlt_i$ for all $i$.
Similarly, after finding appropriate permutations to align the atoms,
