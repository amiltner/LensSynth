...
format.
\emph{Lenses}~\cite{Focal2005-long} solve this problem
...
reading, editing, and writing data sources.  A lens comprises two functions,
called \emph{get} and \emph{put}.  The \emph{get} function translates
...
challenge of learning these languages and using them effectively may have slowed
...
Furthermore, DNF lenses' typing derivations have two typing judgements to fix
...
the second judgement aligns the terms with the types.
...
We use the two typing judgements to prove that our two-phased synthesis
...
\item We present a sound and complete type-directed algorithm for synthesizing
  ...
  algorithms to make these more difficult problems tractable.
...
all benchmarks in under 5 seconds, despite competing tools finding fewer
...
\end{lstlisting}
%
We would like to be able to synthesize a lens $\Lens$, which satisfies the
...
will replace one regular expression with another equivalent to it.
