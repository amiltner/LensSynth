...
program in {\em Boomerang} (a bidirectional language based on the
...
one that is intractable to one that is highly efficient, able to synthesis lenses
...
well-typed, example-compatible Boomerang term.  Search for the
...
\item While we are not aware of any other systems for automatically
 ...
 complex and varied formats and transformations than is possible in 
 current string transformation systems that do not use this information.
