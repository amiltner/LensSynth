...
bijections created from the following Boomerang lens combinators, mapping between
...
\item[\NoFPEMode{}:] Like \NoPDMode{}, but \FixProblemElts{} is never called,
  ...
  through \ExpandOnce{}.
\item[\NoERMode{}:]  Like \NoFPEMode{}, but there is expansions are only processed
