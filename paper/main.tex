...
$\Regex_1$ and $\Regex_2$ are 
\textit{unambiguously concatenable}, meaning there is
exactly one way to divide any
string $\String$ in $\LanguageOf{\Regex_1\Concat\Regex_2}$  (the language of $\Regex_1\Concat\Regex_2$) into $\String_1$
and $\String_2$ such that $\String_1$ is in $\LanguageOf{\Regex_1}$
and $\String_2$ is in $\LanguageOf{\Regex_2}$.  These 
