...
divides an input string $\String$ into two substrings $\String_1$ 
...
from strings $t$ to strings $s$ in an analogous way.
The type system for lenses ensures these \emph{get} and \emph{put} functions
form a bijection.  To type the concatenation lens, we use the
typing rule: 
\[
  \inferrule
  {
