...
\begin{definition}
  Let $\Property$ be a binary relation.  $\StarOf{\Property}$ is
  the reflexive, transitive closure of $\Property$.
\end{definition}
...
\begin{definition}
  ...
  reflexive, transitive, symmetric closure of $\Property$.
\end{definition}
...
\begin{definition}[Parallel Rewriting]\leavevmode
  \begin{mathpar}
    ...
    {
      \StarOf{\DNFRegex} \RewriteToAtom \DNFOf{\SequenceOf{\StarOf{\DNFRegex'}}}
    }
...
\begin{lemma}
  \label{lem:copyable_expansions_left}\leavevmode
  \begin{enumerate}
...
\begin{lemma}
  \label{lem:copyable_expansions_right}\leavevmode
  \begin{enumerate}
  \item Let $\DNFLens \OfRewritelessType \DNFRegex \Leftrightarrow
...
\end{lemma}
\begin{proof}
  This can be proven symmetrically to Lemma~\ref{lem:copyable_expansions_left}.
\end{proof}

\begin{lemma}[Confluence of Parallel Rewriting]
  For all lenses $\Lens$,
