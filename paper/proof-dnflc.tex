...
\SequenceSep\String_{3,n}}$ be conjuncts,
...
\item If $\Sequence$ is a strongly unambiguous conjunct, then
there exists a conjunct lens $\SequenceLens \OfType \Sequence \Leftrightarrow \Sequence$,
