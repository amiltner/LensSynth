...
{
\FullContext \vdash \ConstLens{\String_1}{\String_2} \OfType \String_1 \Leftrightarrow \String_2 \HasSemantics \lambda \String. \String_2 , \lambda \String. \String_1
}
\end{mathpar}
...
{
\FullContext \vdash \Lens \OfType \Regex \Leftrightarrow \RegexAlt \HasSemantics \PutRight , \PutLeft \\
...
{
\FullContext \vdash \Lens_1 \OfType \Regex_1 \Leftrightarrow \RegexAlt_1 \HasSemantics \PutRight_1, \PutLeft_1\\
\FullContext \vdash \Lens_2 \OfType \Regex_2 \Leftrightarrow \RegexAlt_2 \HasSemantics \PutRight_2, \PutLeft_2\\\\
...
{
\FullContext \vdash \ConcatLens{\Lens_1}{\Lens_2} \OfType \Regex_1\Regex_2 \Leftrightarrow \RegexAlt_1\RegexAlt_2 \HasSemantics\\\\
...
{
\FullContext \vdash \Lens_1 \OfType \Regex_1 \Leftrightarrow \Regex_2 \HasSemantics \PutRight_1,\PutLeft_1\\
\FullContext \vdash \Lens_2 \OfType \Regex_2 \Leftrightarrow \Regex_3 \HasSemantics \PutRight_2,\PutLeft_2\\
}
{
\FullContext \vdash \ComposeLens{\Lens_2}{\Lens_1} \OfType \Regex_1 \Leftrightarrow \Regex_3 \HasSemantics
...
\begin{mathpar}
\inferrule[Const Lens]
{
}
{
\FullContext \DerivesLens \ConstLens{\String_1}{\String_2} \OfType \MapsBetweenTypeOf{\String_1}{\String_2} \HasSemantics \lambda \String.\String_2,\lambda \String.\String_1
}
\end{mathpar}
Consider
\begin{mathpar}
...
{
\emptyset,\emptyset \DerivesLens \ConstLens{\String_1}{\String_2} \OfType \MapsBetweenTypeOf{\String_1}{\String_2} \HasSemantics \lambda \String.\String_2,\lambda \String.\String_1
}
\end{mathpar}
...
\Regex{}', such that \LanguageOf{\RegexContext}{\Regex}=\LanguageOf{\emptyset}{\Regex'}.
Consider
\begin{mathpar}
\inferrule[Identity Lens]
{
...
{
\emptyset,\emptyset \DerivesLens \IdentityLens \OfType \MapsBetweenTypeOf{\Regex'}{\Regex'} \HasSemantics \lambda \String.\String, \lambda \String . \String
}
\end{mathpar}
By inspection, this has the same semantics,
