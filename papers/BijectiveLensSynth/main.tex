...
how these lenses map between the subcomponents of their types.
...
lenses in $\DNFLens$ are there are sequences in each of $\DNFRegex$ and
...
algorithm may be factored into two distinct steps: one step that
