...
%
Unfortunately, these languages are difficult to program in,
forcing the programmer to juggle the multiple ways of interpreting their terms.
In Boomerang, a single term represents
...
These languages impose fiddly constraints on lenses, making lens programming
...
are merely bijections composed with projections, where the projections remove
...
Moreover, including these format
...
requires the user to input a program, instead of merely specifications.
...
space of synthesized functions to bijective ones, reducing the search space, but
also reducing expressivity.
