...
This paper also builds on our previous work where we showed how to synthesize
bijective lenses from a pair of regular expressions describing the source and
target types and a set of input-output examples. We refer the reader to the
Related Work section of \cite{popl18} for a survey of the area of
type-and-example driven synthesis.
