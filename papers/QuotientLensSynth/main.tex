...
\bcp{Not sure there is time to fix this, but the intro seems very long and
  ...
  ``Example'' section.} 
\fi
\bcp{This sentence could be clearer!}{\em Bidirectional programming languages} such as
Boomerang~\cite{boomerang}, Augeas~\cite{augeas}, XSugar~\cite{xsugar},
biXid~\cite{bixid} and X/Inv~\cite{xinv}\bcp{there are many others; we
  should mention all of them} enable a programmer to express a
...
for now and then just give the details of that.  (Related: The
``abstract/concrete'' terminology doesn't make much sense in the bijective
setting.)} 
\begin{align*}
...
The expression \bcp{mangled---did you proofread this?}\cd{project [
...
\begin{figure}[t]
  ...
  \caption{Quotient Lens with ``Canonizers at the Edges''\sam{This is a
      ...
      easy if I know how it should look.)}}
