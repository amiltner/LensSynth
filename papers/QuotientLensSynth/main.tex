...
constrained by lens laws. However, these constraints are sometimes too strict.
For example, the data may be such that a record can be represented in many ways
because of the presence of spurious whitespace characters or reordering of
fields. In such cases, deriving a lens which obeys the lens laws becomes a
daunting task.
...
with the standard tools available. Moreover, many of the equivalences
