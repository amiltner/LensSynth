...
Our plan for this paper is as follows:\bcp{This should not just explain the
  plan, but rather state the contributions {\em as contributions},
  not only summarizing what they are but suggesting why they are novel,
...
\sam{More explanation here?}\bcp{Probably not needed---we're going straight
  on to the detailed explanation anyway.}
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    excess whitespace e.g. \bcp{Suggest using $\backlash${\tt mathtt} for 
...
\[
  ...
  \caption{QRE Equivalence Relations\bcp{too wide}}
  \label{fig:relations}
\end{figure}
\begin{figure}[t]
  \begin{center}
