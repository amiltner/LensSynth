...
equivalence relation on that data. This leads to repetitive code since the
regular expression that defines the data and the equivalence relation defined on
the regular expression follow the same syntactic patter---one can do both things
with the same code with only a few changes.

\sam{TODO: PUT EXAMPLE HERE!}
...
express many equivalences which occur in real world data as we shall demonstrate
