...
simultaneously, a regular language and an equivalence relation on it.
...
\begin{enumerate}
  ...
  previously studied in past work~\cite{miltner2017synthesizing} (Section~\ref{synth}).
