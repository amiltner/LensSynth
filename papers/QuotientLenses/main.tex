...
bijective. Of these We found that 4 of Optician's 39 benchmarks required
modifications to be in bijective correspondence when in canonical form.
...
statistics by zip code from xml form into rdf form.\bcp{It's a bit hidden in the figure...} To validate this performance
was not due to our overhead, we modified this format to be bijective, so it
...
were exceptionally large, requiring conversions between over 40 fields.
