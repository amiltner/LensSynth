...
\end{lstlisting}
\caption{QRE specification of \bibtex{} records. \ksf{Is all this code
correct?  Does it run through the system correctly?  I'm suspicious of
the comma\_to\_space definition which seems to be recurisive.  If it's
correct, we should comment on it.}\ksf{In what sense is this a QRE
