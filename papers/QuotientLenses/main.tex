...
\canonize(Q^*)(w_1 \cdot w_2) &=& \canonize(Q)(w_1)\cdot\canonize(Q^*)(w_2) \\
\end{array}
\]
\end{center}
\begin{align*}
...
operators on functions.}\afm{I tried rewriting with explicit arguments,
thoughts?}\saz{If so, do it consistently everywhere. I fixed \id{} but the
others need to be fixed too.}}
