...
into a functionally equivalent lens that canonizes source and target data only
once at the ``edges'' then uses a bijective lens to map between the respective
