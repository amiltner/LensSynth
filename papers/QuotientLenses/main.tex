...
Consider a bidirectional transformation that converts
...
\end{verbatim}
\noindent
to an equivalent EndNote format like the following
\begin{verbatim}
%0 Book
...
and vice versa.
%
Transformations from one such representation to the other will preserve
most of the information content of the data:  the title, the author,
and the key, for instance.  However, intuitively,
some of the information is inessential and may be discarded---indeed, this
inessential information will likely appear so trivial that a casual
reader may not even realize it is there to begin with.  For instance,
there is no need to preserve the amount of whitespace between words, at the ends of lines, or
between fields.  In addition, the order of author and title fields is irrelevant.
There may also be additional equivalent ways of writing the same
name:  ``Conway, J. H.'' and ``J. H. Conway'' should probably be treated
the same.
...
information, it is often useful to treat them as identical.
