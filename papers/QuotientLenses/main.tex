...
if \codefont{comma\_name} describes the format for ``Conway, J. H.''
and \codefont{space\_name} describes the format for ``J. H. Conway''
and \codefont{s\_to\_c} is a function from one to the other then
...
\item \kw{id} $r$: copy the text matching $r$ in both directions \dpw{this was not the exact syntax.  fix this.}
\end{itemize}
%
