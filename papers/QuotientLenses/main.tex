...
QREs. We prove that every composition of QRE lenses can be rewritten
...
Generating a QRE lens requires only a pair of QREs to describe the
...
the comma-separated form describd by the QRE \codefont{comma_name}
and the space-separated form described by the
QRE \codefont{space_name}. 



Given this information, we can exploit and
...
the same name:  ``Lovelace, Adan'' vs ``Ada Lovelace.''
