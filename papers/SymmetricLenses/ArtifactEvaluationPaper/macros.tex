...
\newcommand{\ExperimentalExampleCounts}
{\input{transformed-data/experimental-example-counts.txt}}

\newcommand{\DeterminizedExampleCounts}
{\input{transformed-data/determinizing-example-counts.txt}}
...
\newcommand{\FullMode}{\textbf{Full}}
\newcommand{\NoCSMode}{\textbf{NoCS}}
\newcommand{\NoFPEMode}{\textbf{NoFPE}}
\newcommand{\NoERMode}{\textbf{NoER}}
\newcommand{\NoUDMode}{\textbf{NoUD}}
\newcommand{\FlashExtractMode}{\textbf{FlashExtract}}
\newcommand{\FlashFillMode}{\textbf{Flash Fill}}
\newcommand{\NaiveMode}{\textbf{Na\"ive}}


% autogenerated from data
\newcommand{\BenchmarkCount}
{\input{transformed-data/benchmark-count.txt}}
\newcommand{\SynthesizedUnder}
{\input{transformed-data/multiple-of-five-number-of-seconds-synthesized-under.txt}}
\newcommand{\AugeasCount}
{\input{transformed-data/augeas-count.txt}}
\newcommand{\MinLensSize}
{\input{transformed-data/min_lens_size.txt}}
\newcommand{\MaxLensSize}
{\input{transformed-data/max_lens_size.txt}}
\newcommand{\NumMoreThanFlashFill}
{35}
\newcommand{\ExamplesRequiringNonzeroExamples}
{5}
\newcommand{\ExpansionsAllForcedNoLC}
{22}
\newcommand{\BenchmarksCompletedNoLC}
{38}
\newcommand{\ExpansionsNotAllForcedNoLC}
{16}
\newcommand{\MedianExpansionsForcedNoLC}
{\input{transformed-data/median_expansions_forced.txt}}
\newcommand{\MaxExpansionsForcedNoLC}
{\input{transformed-data/maximum_expansions_forced.txt}}
\newcommand{\NoUDSuccessCount}
{8}
\newcommand{\ExpansionsPerformedNaiveExpansionSuccess}
{5}
\newcommand{\FlashFillSuccesses}
{3}
...
%   296 gen.ml
%   459 lang.ml
%   112 language_equivalences.ml
%   452 lens_utilities.ml
%   178 lenscontext.ml
%   421 normalized_lang.ml
%   298 permutation.ml
%   187 regex_utilities.ml
%    94 regexcontext.ml
%     4 stdlib.ml
%   134 string_utilities.ml
%    66 synth_structs.ml
%  3713 total
\newcommand{\LOC}{3713}
