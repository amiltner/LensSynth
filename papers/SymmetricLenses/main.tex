...
implemented Boomerang's asymmetric lens combinators \sam{all of Boomerang's combinators?} using the symmetric lens combinators.
...
\item We adapted \afm{29} benchmarks from Augeas. These benchmarks turn the
  ...
  representation. \sam{What does data cleaning mean?}
