...
\item We give an algorithm for synthesizing lenses built from these combinators,
  ...
  semantic meaning. \bcp{``Semantic meaning'' is redundant.  And ``deep
    semantic meaning'' just sounds silly.  Can we say it more precisely?}
%
...
\end{itemize}
Along the
way, we show that {\em star-semiring equivalences}\bcp{citation} on regular
expressions 
...
\label{subsec:lenscosts} \bcp{In the intro, we talked about ``likelihood.''
Now we seem to be switching the terminology to ``cost.''}
