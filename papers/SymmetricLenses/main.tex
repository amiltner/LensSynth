...
woudl have that affect.}\saz{Stephanie says we should cite it in the third
...
The second difficulty appears to be more fundamental\dpw{better word?}:
...
one bit, together with the SRE, suffices to recover the string in question.
...
With SREs in hand, we develop a new algorithm for synthesizing likely lenses.
...
and which we have proven does not alter the probability distributions of the languages.
...
from XXXX to YYYYY. We found that ... \dpw{give a number of two that characterize
