...
evaluate
its performance on 48 benchmark examples drawn from FlashFill, Augeus,
...
characteristic, 48 benchmarks in total. Consequently, tools that search
...
synchronization tasks taken from a variety of other locations\footnote{The
  majority of these format synchronization tasks were derived from the
...
39 of our 48 benchmarks, our termination condition is not
...
\item We used 11 benchmarks from synchronization tasks between a variety of
  formats taken from the bidirectional programming literature. These tasks range
  from synchronizing REST and JSON web resource descriptions to synchronizing
  BibTeX and EndNote citation descriptions.
\end{enumerate}
