...
from Flash Fill~\cite{gulwani-popl-2014}, information 
extraction tasks \ksf{Dave wants to change information extraction to
soemthing else.} taken from Augeas~\cite{Augeas}, and ad hoc format synchronization tasks
...
\item We extend Boomerang with simple symmetric lenses,
  ...
  data cleaning, \ksf{Dave wants to change information extraction to
soemthing else.} information 
  extraction, and file synchronization tasks.  We demonstrate that we can
