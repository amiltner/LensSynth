...
\ksf{Should we be talking about ``best'' or just ``good'' or ``low''?
There are typically a collection of ``best'' lenses, and we choose the
one that requires the simplest permutation.}
Now that we have a notion of best, we need a way to search for that
best lens.  Previous work on synthesis~\ksf{add citations} has shown
