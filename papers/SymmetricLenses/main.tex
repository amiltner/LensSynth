...
Our algorithm must resolve a three-way tension among the quality of
...
satisfying lens has relatively high likelihood, indicating the lens is very
...
respond with a satisfying lens with relatively high likelihood. If users are
...
number of satisfying lenses, or they can supply annotations (discussed in
\S\ref{subsec:optimizations}) informing describing whether certain information
should be retained through format conversion.
...
model for our language. We do this with \emph{stochastic regular expressions}~\cite{stoch-rnn,stoch-def},
...
represents the likelihood that the string is in $\Regex_1$. In the stochastic regular
