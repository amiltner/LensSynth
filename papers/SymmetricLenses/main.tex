...
procedure as extensions to the Boomerang language~\cite{Boomerang} and evaluate
its performance on a range of benchmark examples. We find this implementation is
able to synthesize all the lenses of this benchmark suite in under 30 seconds.
\end{abstract}
