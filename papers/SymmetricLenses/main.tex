...
\item How effective is the information-theoretic search heuristic and how does
  termination tuning affect the results?
\end{enumerate}
...
Having determined appropriate examples and timing parameters for the 48
benchmarks, we evaluate the performance of the system by 
measuring the running time of our algorithm in two modes:
...
\begin{tabulary}{\linewidth}{rL}
  ...
  \FLOpt{}: &  \GreedySynth uses the information-theoretic preference
              metric to find a lens, and we return immediately upon finding a
