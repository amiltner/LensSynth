...
satisfies all the input/output examples. We this a \emph{satisfying
...
components of the example itself\bcp{huh?}). In general, {\em many} examples
may be 
required to rule out all possible occurrences of nested\bcp{??} \Disconnect lenses,
...
\proposedelete{While we could ask programmers to provide detailed and precise specifications
...
strings $s$ and $t$ are \emph{synchronized according to lens
  $l$}\bcp{Earlier we used $\Lens$, now we are switching to $l$...} if $l.\PutR\
