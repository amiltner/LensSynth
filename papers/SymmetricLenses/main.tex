...
lenses in under 30 seconds.  \bcp{All of them together take 30 seconds?  Or
  the maximum time it takes for one is 30 seconds?}
\end{abstract}
...
information, is  
limited.  A more common situation is where two data
...
total.  \bcp{I don't understand this.  We say that the non-bijective
  situation is ``more common,'' but we support this by saying that 13 out of
48 benchmarks (that we chose!) are non-bijective.  Or am I misreading??}
