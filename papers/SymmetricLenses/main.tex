...
All three sources provide realistic problems suitable for answering the research
questions: Flash Fill data cleaning tasks are either derived from online help
forums or taken from the Excel product team; Augeas is a utility that transforms
Linux configuration files into a manageable dictionary form; and many of the
remaining benchmarks arise from synchronizing real-world data formats such as
BibTeX and EndNote. Each task consists of a source and target regular
expression. These tasks can be quite quite large, as we are synthesizing complex
transformations between real file formats -- some of the lenses and
specifications are over 500 AST nodes.
