...
\dpw{fill in with accurate stats.}
...
from past instances of $S$ or $T$ when making a round trip.\dpw{fix that}
...
very little information from $t$ is required to generate it. \dpw{check that I'm saying
that correctly (and repair).  I think it is a bit off.}
