...
techniques.  In this section, we consider the relationship with
classical symmetric lenses in depth and also comment on related
program synthesis techniques.

\subsection{Relationship with Classical Symmetric Lenses}
...
on a specific domain, as we have done here.
