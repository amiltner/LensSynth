...
on 48 benchmark examples drawn from Flash Fill, Augeus, the bidirectional
...
48 benchmarks (that we chose!) are non-bijective.  Or am I misreading??} \afm{I
think this is due, in part, to where we got the benchmarks (Augeas typically removes
little information). I do think that
it is more common, but I suppose I have no real data on that. I've updated
the wording to be ``safer''.}
