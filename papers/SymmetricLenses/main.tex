...
tuning.  In all cases, the desired lens was obtained, which we verified by
...
Adjusting the tuning parameter was needed in only 9 of the 48 tasks. In practice, we
