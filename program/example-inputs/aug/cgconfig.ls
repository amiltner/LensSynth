...
mount_map = [MOUNT_CONF <=> MOUNT_DICT {}]
...
controller_map = [CONTROLLER_CONF <=> CONTROLLER_DICT {}]
...
admin_map = [ADMIN_CONF <=> ADMIN_DICT {}]
...
group_map = [GROUP_CONF <=> GROUP_DICT {}]
