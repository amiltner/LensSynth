...
typedef INSIDE1 = perm(BIBTEXJOURNAL ",", BIBTEXAUTHORINFO ",", BIBTEXTITLE ",") with "";;

typedef FULLBIBTEX = "{" INSIDE1 "}";;

typedef FULLTAGS = perm (TAGGEDAUTHORDEFNS, TAGGEDTITLE, TAGGEDJOURNAL) with "\n";;
